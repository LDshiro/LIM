...
function Mdx=dMdx(a,b,h)

    Mdx=0;
    sum=0;
    
        We=[-0.973906528517171720078 0.0666713443086881375936;
    ...
    w1=2*a*b/(h^2+a^2+b^2);
        ...
        for j = 1:10
            ...
            den=cos(theta)*(1-w1)^2;
            num=(1-w1*cos(theta))^(3/2);
        ...
        Mdx=sum*(mu/(2^(3/2)))*(h/sqrt(a*b*w1))*(w1/(1-w1))^2*pi*0.5; %%%%Ï•ª”ÍˆÍ‚Å0.5‚ğŠ|‚¯‚Ä‚İ‚½@
end